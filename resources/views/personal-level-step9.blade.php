							...
							<div class="foods-list">
								...
								<div class="outer-input foods-check">
									<div class="form-group">
										...
										<label for="allsame">I have never eaten Eggs</label>
									</div>
								</div>
							</div>
						</div>
...
<a href="{{url('/personal-level-step10')}}" class="link-btn hvr-forward get-survey-details"><i class="fa fa-arrow-right fa-3x"></i></a>
			</div>
		</div>
	</div>
	</div>
