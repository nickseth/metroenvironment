...
<div class="clmn-grid">
 ...
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-1.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Image/promotion/branding</div></div> <div class="col-sm-6"><div class="clmn-grid-slider orange" id="range-slider-1">
 <div class="range ">
 ...
 <div class="clmn-grid">
  ...
  <div class="row">
   <div class="col-sm-12">
  <div class="two-clmn-flex">
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-2.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Cost reduction</div></div> <div class="col-sm-6"><div class="clmn-grid-slider orange" id="range-slider-2">
 <div class="range ">
 ...
 <div class="clmn-grid">
  ...
  <div class="row">
   <div class="col-sm-12">
  <div class="two-clmn-flex">
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-3.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Political requirements/laws<br>(national and European/international)</div></div> <div class="col-sm-6"><div class="clmn-grid-slider green" id="range-slider-3">
 <div class="range ">
 ...
 <div class="clmn-grid">
  ...
  <div class="row">
   <div class="col-sm-12">
  <div class="two-clmn-flex">
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-4.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Ecological responsibility</div></div> <div class="col-sm-6"><div class="clmn-grid-slider dark-green" id="range-slider-4">
 <div class="range ">
 ...
 <div class="clmn-grid">
  ...
  <div class="row">
   <div class="col-sm-12">
  <div class="two-clmn-flex">
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-5.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Motivation of the workforce</div></div> <div class="col-sm-6"><div class="clmn-grid-slider green"id="range-slider-5">
 <div class="range ">
 ...
 <div class="clmn-grid">
  ...
  <div class="row">
   <div class="col-sm-12">
  <div class="two-clmn-flex">
 <div class="row"> <div class="col-sm-2"><div class="clmn-grid-icon"><img src="images/sec-3-img-6.svg" /></div></div><div class="col-sm-4"><div class="clmn-grid-text blue-text">Social responsibility</div></div> <div class="col-sm-6"><div class="clmn-grid-slider green" id="range-slider-6">
 <div class="range ">
