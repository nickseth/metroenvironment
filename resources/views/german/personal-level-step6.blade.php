	...
	<path class="st194" d="M103.3,38.6c-0.7-1.1-1.2-2.2-2.2-4.5c-0.4-0.9-0.5-1.1-0.4-1.9c0-0.1,0-0.3-0.2-0.3   c-1.2,0.4-2.4,1.1-3.2,1.8c-0.9,0.9-1.6,2.1-2.3,3.2c-0.7,1.2-0.8,1.6-1.6,2.7c-0.4,0.6-0.9,1.2-0.4,0.8c1.3-1,2.2-2.3,3.1-3.7   c1.1-1.7,2.2-3.2,3.9-4.4c0.2,2.6,2.6,5.4,3.5,6.5C103.9,39.3,103.5,39,103.3,38.6z"/>
								...
								<div class="outer-input foods-check">
									<div class="form-group">
										...
										<label for="allsame_personal_step_6">Ich habe noch nie Geflügelfleisch gegessen.</label>
									</div>
								</div>
							</div>
						</div>
...
<a href="{{url('/de/personal-level-step7')}}" class="link-btn get-survey-details btn-flip" data-back="WEITER" data-front="WEITER" ></a>
			</div>
		</div>
		<div class="col-sm-12 text-center step-text">
		<p class="animate__animated animate__fadeIn gray-text">9 von 25</p>
		</div>
	</form>
	</div>
