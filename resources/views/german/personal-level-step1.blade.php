...
<div class="container "><div class="relative">
 ...
 <p class="animate__animated animate__fadeIn gray-text">Bewegen Sie den Schieberegler auf dem Kreis auf einer Skala von 1 bis 5, um Ihre Antwort einzureichen, wobei 1 = am wahrscheinlich und 5 = am wahrscheinlichsten entspricht</p>
...
<a href="{{url('/de/personal-level-step2')}}" class="link-btn get-survey-details btn-flip" data-back="WEITER" data-front="WEITER" ></a>
</div>
 </div>
 </div></div>
