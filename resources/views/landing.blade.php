...
<div class="loader-wrap"><div class="loader"><div class="loadersmall"></div></div></div>
 <h2 class="text-center google-head" style="text-transform:uppercase">This website is available in the following languages:</h2>
...
1. This website is best viewed on your PC in 1920x1080 resolution.<br/>
