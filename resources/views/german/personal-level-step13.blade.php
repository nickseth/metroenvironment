...
die die Kaufentscheidung beeinflussen?</div>
					...
					<div class="col-sm-12">
						...
						<img src="../german_assets/images/cart-boy-anim.gif"/>
...
<a href="{{url('/de/personal-level-step14')}}" class="link-btn get-survey-details btn-flip" data-back="WEITER" data-front="WEITER" ></a>
			</div>
		</div>
	</form>
	</div>
