...
<input type="hidden" class="hidden-circular-slider-input" value="0" name="final_level_step11"/>
</form>
<div class="circular-range-slider"></div>
 </div></div>
<div class="button-wrapper bottom-button">
<a href="{{url('/final-level-step12')}}" class="link-btn hvr-forward get-survey-details"><i class="fa fa-arrow-right fa-3x"></i></a>
</div>
 </div>
 </div></div>
