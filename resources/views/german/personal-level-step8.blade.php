...
<g>
	...
	<path class="st270" d="M27.2,13.3c-1.2-0.1-3.3,0.7-3.9,1C22,15,20.6,15.9,19.6,17c-0.9,1-1.5,2.7-0.6,3.9c1.2,1.6,3.1,0.3,4-0.8   c1.2-1.4,2.7-2.4,4.5-3.1c1.1-0.4,2.5-0.8,2.7-2.2C30.4,13.1,28.9,13,27.2,13.3z"/>
											...
											<p class="light-text">Eiscreme</p>
										</div>
									</div>
								</div>
								</div>
								<div class="rangle-slider pink-range foods-range">
									<p class="animate__animated animate__fadeIn dark-text">MILCHPRODUKTE</p>
									<div class="range">
								...
								<div class="outer-input foods-check">
									<div class="form-group">
										...
										<label for="allsame_personal_step_8">Ich habe noch nie Milchprodukte gegessen.</label>
									</div>
								</div>
							</div>
						</div>
