...
<p class="animate__animated animate__fadeIn dark-text">Companies that use little or no plastic packaging</p>
<div class="range">
...
<a href="{{url('/personal-level-step16')}}" class="link-btn get-survey-details btn-flip" data-back="Next" data-front="Next" ></a>
			</div>
		</div>
	</form>
	</div>
