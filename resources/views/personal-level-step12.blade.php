...
<div class="vegi-group">
 ...
 <div class="plate-item-3 plate-item" style="z-index: 99;"><img src="images/plate-item-3.svg" /></div><p class="text-center"><strong>Tofu/soy products</strong>(soy cutlets, seitan, tempeh etc.)</p></div>
<div class="col-sm-6">
...
</div></div><div class="col-sm-3 mt-5"> <div class="plate-item-4 plate-item" style="z-index: 99;"><img src="images/plate-item-4.svg" /></div><p class="text-center"><strong>Nuts/seeds</strong>(pumpkin- sunflower seeds, peanuts, cashew etc.)</p></div></div>
 </div>
</div>
